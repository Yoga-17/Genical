...
class Infopage extends StatefulWidget {
  ...
  const Infopage(
      {super.key, required this.xfilePick, required this.responseText});
...
class _InfopageState extends State<Infopage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const Imagepickpage()));
          },
          icon: const Icon(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _buildGridButton(
                    context, 'HISTORY', Icons.history, medicineInfo),
                const SizedBox(width: 10),
                _buildGridButton(
  ...
  Widget _buildGridButton(BuildContext context, String text, IconData icon,
    ...
    final HISTORY = medicineInfo['history'] ?? 'No information available';
